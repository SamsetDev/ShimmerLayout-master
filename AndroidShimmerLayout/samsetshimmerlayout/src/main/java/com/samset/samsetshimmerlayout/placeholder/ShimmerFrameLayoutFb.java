package com.samset.samsetshimmerlayout.placeholder;

/**
 * Created by Samset on 11/16/17.
 */
...
public class ShimmerFrameLayoutFb extends FrameLayout {
    ...
    public ShimmerFrameLayoutFb(Context context) {
        this(context, null, 0);
    }

    public ShimmerFrameLayoutFb(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerFrameLayoutFb(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerLayout, 0, 0);
            try {
                if (a.hasValue(R.styleable.RecyclerLayout_auto_start)) {
                    setAutoStart(a.getBoolean(R.styleable.RecyclerLayout_auto_start, false));
                }
                if (a.hasValue(R.styleable.RecyclerLayout_base_alpha)) {
                    setBaseAlpha(a.getFloat(R.styleable.RecyclerLayout_base_alpha, 0));
                }
                if (a.hasValue(R.styleable.RecyclerLayout_duration)) {
                    setDuration(a.getInt(R.styleable.RecyclerLayout_duration, 0));
                }
                if (a.hasValue(R.styleable.RecyclerLayout_repeat_count)) {
                    setRepeatCount(a.getInt(R.styleable.RecyclerLayout_repeat_count, 0));
                }
                if (a.hasValue(R.styleable.RecyclerLayout_repeat_delay)) {
                    setRepeatDelay(a.getInt(R.styleable.RecyclerLayout_repeat_delay, 0));
                }
                if (a.hasValue(R.styleable.RecyclerLayout_repeat_mode)) {
                    setRepeatMode(a.getInt(R.styleable.RecyclerLayout_repeat_mode, 0));
                }

                if (a.hasValue(R.styleable.RecyclerLayout_angle)) {
                    int angle = a.getInt(R.styleable.RecyclerLayout_angle, 0);
                    switch (angle) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.RecyclerLayout_shape)) {
                    int shape = a.getInt(R.styleable.RecyclerLayout_shape, 0);
                    switch (shape) {
                        default:
                        case 0:
                ...
                if (a.hasValue(R.styleable.RecyclerLayout_dropoff)) {
                    mMask.dropoff = a.getFloat(R.styleable.RecyclerLayout_dropoff, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_fixed_width)) {
                    mMask.fixedWidth = a.getDimensionPixelSize(R.styleable.RecyclerLayout_fixed_width, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_fixed_height)) {
                    mMask.fixedHeight = a.getDimensionPixelSize(R.styleable.RecyclerLayout_fixed_height, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_intensity)) {
                    mMask.intensity = a.getFloat(R.styleable.RecyclerLayout_intensity, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_relative_width)) {
                    mMask.relativeWidth = a.getFloat(R.styleable.RecyclerLayout_relative_width, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_relative_height)) {
                    mMask.relativeHeight = a.getFloat(R.styleable.RecyclerLayout_relative_height, 0);
                }
                if (a.hasValue(R.styleable.RecyclerLayout_tilt)) {
                    mMask.tilt = a.getFloat(R.styleable.RecyclerLayout_tilt, 0);
                }
            } finally {
                a.recycle();
            }
